                	...
                	<div class="row hidden-on">
                    	<div class="col-md-4 hidden-xs" style="position: absolute; top: 50px;">
                        	<div class="contact_text_img">
                                ...
                                <p><a class="allbuttonS allbutton1S" href="#">Contact Us</a>&nbsp;&nbsp;
                                <a class="allbuttonS allbutton1S" href="<?php optionTree_specific_value('social_settings', 'Facebook'); ?>" target="_blank">Find us</a></p>
    ...
    <div class="row testcol">
    	<div class="col-xs-12">
        	<h2 class="text-center text-uppercase" style="padding-bottom: 0; margin-top: 0; padding-top: 0; margin-bottom: 15px;">
                ...
                <?php echo get_field('section_title',$id); ?>
            </h2>
            <p><?php echo get_field('section_content',$id); ?></p>
        </div><!-- /.col-xs-12 -->
    </div><!-- /.row -->
    <div class="row">
