...
<div class="row rowbottomarrow">
    ...
    <?php 
	$show_first_column_settings = get_field('show_first_column_settings');
	if($show_first_column_settings == "Yes"){ ?>
    <div class="common-feature-image">
    <?php
	// check if the repeater field has rows of data
	if( have_rows('all_images') ):	
		// loop through the rows of data
		while ( have_rows('all_images') ) : the_row();
			echo '<div class="col-xs-12 col-md-4 col-sm-4">';
				echo '<a href="'.get_sub_field('image_link').'"><img src="'.get_sub_field('single_image').'" class="img-responsive" alt="" /></a>';			
			echo '</div><!-- /.col-md-4 -->';	
		endwhile;	
	else :	
		// no rows found	
    ...
    <?php 
	$show_second_column_settings = get_field('show_second_column_settings');
	if($show_first_column_settings == "Yes"){ ?>
    <div class="common-feature-image">
    <?php
	// check if the repeater field has rows of data
