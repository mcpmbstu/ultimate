...
<div class="row rowbottomarrow">
    ...
    <?php
	$second_column_images = get_field('show_second_column_settings');
	//print_r($second_column_images);
	//echo 'test here';
	if($second_column_images == "Yes"){ ?>
    <div class="common-feature-image">
    <?php
	// check if the repeater field has rows of data
	if( have_rows('second_column_images') ):	
		...
		while ( have_rows('second_column_images') ) : the_row();
			echo '<div class="col-xs-12 col-md-4 col-sm-4">';
				if(!empty(get_sub_field('package_link'))){
				echo '<a href="'.get_sub_field('package_link').'"><img src="'.get_sub_field('feature_package_image').'" class="img-responsive" alt="" /></a>'; }else{
                ...
                <div class="verticalDiv" style="background: url(<?php echo get_template_directory_uri(); ?>/images/banner1.png) center center no-repeat;">
                      <div class="verticalDivInner">
                         ...
                         <div class="week-post-social">
                             <a href="https://www.facebook.com/TheUltimateAdventureCentre" style="color: #fff;"><span class="fa-stack fa-2x">
                              <i class="fa fa-circle fa-stack-2x"></i>
                              <i class="fa fa-facebook fa-stack-1x fa-inverse"  style="color: #666;"></i>
                            </span></a><!-- /. social file -->
                            <a href="https://twitter.com/UACNorthDevon" style="color: #fff;"><span class="fa-stack fa-2x">
                              <i class="fa fa-circle fa-stack-2x"></i>
                              <i class="fa fa-twitter fa-stack-1x fa-inverse"  style="color: #666;"></i>
                            </span></a><!-- /. social file -->
                            <a href="#" style="color: #fff;"><span class="fa-stack fa-2x">
                              <i class="fa fa-circle fa-stack-2x"></i>
...
// 			}
			?>
            <?php if(!empty(get_field('third_column_title_page',$post->ID))){ ?>
        	<div class="col-xs-12">
            	<h2 class="text-center text-uppercase">
            ...
            <?php }else{ ?>
            	<!--<div style="width: 100%; min-height: 580px;"></div>-->
                <style type="text/css">
                	.bg-testomnial{
