    ...
    <div class="container bgwhite testimonialHome">
     ...
     <div id="carousel-testimonial" class="carousel fade" data-ride="carousel">
        ...
        <div class="row row-lists-view hidden-xs">
			...
			?> 
                <p><a href="<?php echo $link; ?>" class="link-more-color"><?php echo $column_1_more_button_texts; ?> <i class="fa fa-chevron-right"></i></a></p>
            </div><!-- /.col-md-4 -->
			...
			?> 
                <p><a href="<?php echo $link; ?>" class="link-more-color"><?php echo $column_2_more_button_texts; ?> <i class="fa fa-chevron-right"></i></a></p>
            </div><!-- /.col-md-4 -->
			...
			?> 
                <p><a href="<?php echo $link; ?>" class="link-more-color"><?php echo $column_3_more_button_texts; ?> <i class="fa fa-chevron-right"></i></a></p>
