...
<?php 
if ( function_exists( 'ot_get_option' ) ) { 
  $contact_form_tracker = ot_get_option( 'contact_form_tracker' );
  echo $contact_form_tracker;
}  
?>
...
<?php 
if ( function_exists( 'ot_get_option' ) ) { 
  $contact_form_tracker = ot_get_option( 'experience_builder_tracker' );
  echo $experience_builder_tracker;
}  
?>
