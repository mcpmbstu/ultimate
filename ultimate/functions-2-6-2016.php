                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="ut_months" id="ut_months" class="required form-control" data-popover-position="top">
                              <option value="none">Months</option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="ut_years" id="ut_years" class="required form-control yearSelect" data-popover-position="top">
                              <option value="none">Years</option> 
                            </select>
                        </div>
                    </div><!-- /.col-md-1 --> 
                </div><!-- /.row -->
...
// map center
var center = new google.maps.LatLng(51.019725, -4.238212);

// marker position
var factory = new google.maps.LatLng(51.019725, -4.238212);
		...
		if ( $the_query->have_posts() ) { 
			...
			while ( $the_query->have_posts() ) {
				...
				$thumb = get_post_thumbnail_id();
					...
					echo '<li><p class="text-left"><a href="'.get_permalink().'">'.get_the_title().'</a><span>'.get_field('short_text').'</span></p></li>';    
